...
zSetDecodedEntriesStreamingDF\
    .withColumn("customer", from_json("customer", CustomerJSONScema))\
    .select(col('customer.*'))\
...
# +--------------------+-----
emailAndBirthDayFieldStreamingDF.writeStream.outputMode("append").format("console").start().awaitTermination()
